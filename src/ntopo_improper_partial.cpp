...
void NTopoImproperPartial::build()
{
    ...
    for (m = 0; m < num_improper[i]; m++) {
      ...
      if (atom1 == -1 || atom2 == -1 || atom3 == -1 || atom4 == -1) {
        ...
        if (lostbond == Thermo::ERROR)
          error->one(FLERR, "Improper atoms {} {} {} {} missing on proc {} at step {}" + utils::errorurl(30),
  ...
  if (all && me == 0) error->warning(FLERR, "Improper atoms missing at step {}" + utils::errorurl(30), update->ntimestep);
}
