...
void NTopoAngleAll::build()
{
    ...
    for (m = 0; m < num_angle[i]; m++) {
      ...
      if (atom1 == -1 || atom2 == -1 || atom3 == -1) {
        ...
        if (lostbond == Thermo::ERROR)
          error->one(FLERR, "Angle atoms {} {} {} missing on proc {} at step {}" + utils::errorurl(30), angle_atom1[i][m],
  ...
  if (all && (me == 0)) error->warning(FLERR, "Angle atoms missing at step {}" + utils::errorurl(30), update->ntimestep);
}
