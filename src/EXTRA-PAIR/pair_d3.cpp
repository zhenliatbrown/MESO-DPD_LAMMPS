...
void PairD3::settings(int narg, char **arg) {
  ...
  rthr = rthr*rthr; cn_thr = cn_thr*cn_thr; // squared cutoff
...
void PairD3::coeff(int narg, char **arg) {
    ...
    the old values
    */
    double r2r4_ref[NUM_ELEMENTS+1] = {0,
    ...
    double rcov_ref[NUM_ELEMENTS+1] = {0,
...
void PairD3::calc_coordination_number() {
  ...
  if (newton_pair) {
    for (int i = 0; i < nall; i++) cn[i] = 0.0, dc6[i]=0.0;
  } else {
...
void PairD3::set_funcpar(std::string& functional_name) {
  ...
  switch (dampingCode) {
    ...
    case 1:{ // zero
      ...
      std::transform(functional_name.begin(), functional_name.end(), functional_name.begin(), ::tolower);

      int functionalCode = functionalMap[functional_name];

      switch (functionalCode) {
      case 1: rs6 = 0.999; s8 = -1.957; rs8 = 0.697; break;
      case 2: rs6 = 1.094; s8 = 1.682; break;
      case 3: rs6 = 1.139; s8 = 1.683; break;
      case 4: rs6 = 0.892; s8 = 0.909; break;
      case 5: rs6 = 0.923; s8 = 1.010; break;
      case 6: rs6 = 1.217; s8 = 0.722; break;
      case 7: rs6 = 1.345; s8 = 0.612; break;
      case 8: rs6 = 1.224; s8 = 0.901; break;
      case 9: rs6 = 0.872; s8 = 0.514; break;
      case 10: rs6 = 1.166; s8 = 1.105; break;
      case 11: rs6 = 1.261; s8 = 1.703; break;
      case 12: rs6 = 1.287; s8 = 0.928; break;
      case 13: rs6 = 1.129; s8 = 0.109; break;
      case 14: rs6 = 1.021; s8 = 0.862; break;
      case 15: rs6 = 1.532; s8 = 0.862; break;
      case 16: rs6 = 1.252; s8 = 1.242; break;
      case 17: rs6 = 1.427; s8 = 1.022; s6 = 0.64; break;
      case 18: rs6 = 1.557; s8 = 0.705; s6 = 0.82; break;
      case 19: rs6 = 1.586; s8 = 0.760; s6 = 0.56; break;
      case 20: rs6 = 1.541; s8 = 0.879; s6 = 0.75; break;
      case 21: rs6 = 1.158; s8 = 1.746; break;
      case 22: rs6 = 1.239; s8 = 1.098; break;
      case 23: rs6 = 1.087; s8 = 2.033; break;
      case 24: rs6 = 1.370; s8 = 1.442; break;
      case 25: rs6 = 1.223; s8 = 1.219; break;
      case 26: rs6 = 1.660; s8 = 0.550; break;
      case 27: rs6 = 1.613; s8 = 1.868; break;
      case 28: rs6 = 0.929; s8 = 1.975; break;
      case 29: rs6 = 0.806; s8 = 1.764; break;
      case 30: rs6 = 0.837; s8 = 2.055; break;
      case 31: rs6 = 1.215; s8 = 0.663; break;
      case 32: rs6 = 1.221; s8 = 0.560; break;
      case 33: rs6 = 1.128; s8 = 1.494; break;
      case 34: rs6 = 1.176; s8 = 1.775; break;
      case 35: rs6 = 0.949; s8 = 0.792; break;
      case 36: rs6 = 1.333; s8 = 0.998; break;
      case 37: rs6 = 1.605; s8 = 1.118; break;
      case 38: rs6 = 1.671; s8 = 1.061; break;
      case 39: rs6 = 1.931; s8 = 2.168; break;
      case 40: rs6 = 1.378; s8 = 1.217; break;
      case 41: rs6 = 1.355; s8 = 1.279; break;
      case 42: rs6 = 1.373; s8 = 0.595; break;
      case 43: rs6 = 1.417; s8 = 0.000; break;
      case 44: rs6 = 1.581; s8 = 0.000; break;
      case 45: rs6 = 1.325; s8 = 0.000; break;
      case 46: rs6 = 1.619; s8 = 0.000; break;
      case 47: rs6 = 1.446; s8 = 0.000; break;
      /* DFTB3(zeta = 4.0), old deprecated parameters; case ("dftb3"); rs6 = 1.235; s8 = 0.673; */
      case 48: rs6 = 1.221; s8 = 1.206; break;
      default:
    ...
    case 2:{ // zerom
      ...
      int functionalCode = functionalMap[functional_name];
      switch (functionalCode) {
        case 1: rs6 = 1.313134; s8 = 0.717543; rs8 = 0.016035; s6 = 0.640000; break;
        case 2: rs6 = 1.338153; s8 = 1.532981; rs8 = 0.013988; break;
    ...
    case 3:{ // bj
      ...
      int functionalCode = functionalMap[functional_name];
      switch (functionalCode) {
        case 1: a1 = 0.3946; s8 = 3.2822; a2 = 4.8516; break;
        case 2: a1 = 0.4298; s8 = 2.6996; a2 = 4.2359; break;
        case 3: a1 = 0.5238; s8 = 2.3550; a2 = 3.5016; break;
        case 4: a1 = 0.1820; s8 = 0.8318; a2 = 4.0094; break;
        case 5: a1 = 0.5545; s8 = 2.2609; a2 = 3.2297; break;
        case 6: a1 = 0.4289; s8 = 0.7875; a2 = 4.4407; break;
        case 7: a1 = 0.4613; s8 = 1.3845; a2 = 4.5062; break;
        case 8: a1 = 0.3981; s8 = 1.9889; a2 = 4.4211; break;
        case 9: a1 = 0.4535; s8 = 1.9435; a2 = 4.4752; break;
        case 10: a1 = 0.3385; s8 = 0.9171; a2 = 2.8830; break;
        case 11: a1 = 0.3768; s8 = 1.2576; a2 = 4.5865; break;
        case 12: a1 = 0.4145; s8 = 1.2177; a2 = 4.8593; break;
        case 13: a1 = 0.383; s8 = 2.310; a2 = 5.685; break;
        case 14: a1 = 0.4309; s8 = 1.4760; a2 = 3.9446; break;
        case 15: a1 = 0.2076; s8 = 0.7257; a2 = 6.3750; break;
        case 16: a1 = 0.3065; s8 = 0.9147; a2 = 5.0570; break;
        s6 = 0.64;
        case 17: a1 = 0.0000; s8 = 0.2130; a2 = 6.0519; s6 = 0.50; break;
        case 18: a1 = 0.0009; s8 = 0.2112; a2 = 5.9807; s6 = 0.50; break;
        case 19: a1 = 0.4870; s8 = 3.2950; a2 = 3.5043; break;
        case 20: a1 = 0.4831; s8 = 2.0077; a2 = 4.5323; break;
        case 21: a1 = 0.5299; s8 = 2.6205; a2 = 2.8065; break;
        case 22: a1 = 0.4466; s8 = 2.9491; a2 = 6.1742; break;
        case 23: a1 = 0.4567; s8 = 4.0728; a2 = 4.3908; break;
        case 24: a1 = 0.5512; s8 = 3.3816; a2 = 2.9444; break;
        case 25: a1 = -0.0952; s8 = -0.1744; a2 = 5.2170; break;
        case 26: a1 = 0.4720; s8 = 0.4389; a2 = 4.0986; break;
        case 27: a1 = 0.4634; s8 = 2.7495; a2 = 4.3153; break;
        case 28: a1 = 0.4312; s8 = 2.8524; a2 = 4.4693; break;
        case 29: a1 = 0.2793; s8 = 1.0354; a2 = 4.9615; break;
        case 30: a1 = 0.4679; s8 = 1.7588; a2 = 3.7619; break;
        case 31: a1 = 0.4529; s8 = 2.2382; a2 = 4.6550; break;
        case 32: a1 = 0.1955; s8 = 1.0508; a2 = 6.4177; break;
        case 33: a1 = 0.1805; s8 = 0.9383; a2 = 7.7627; break;
        case 34: a1 = 0.2092; s8 = 1.4507; a2 = 5.5545; break;
        case 35: a1 = 0.1940; s8 = 2.0860; a2 = 5.9197; break;
        case 36: a1 = 0.3708; s8 = 2.0674; a2 = 5.4743; break;
        case 37: a1 = 0.3919; s8 = 1.8541; a2 = 5.0897; break;
        case 38: a1 = 0.0000; s8 = 0.2597; a2 = 6.3332; s6 = 0.560; break;
        case 39: a1 = 0.0000; s8 = 0.2804; a2 = 6.5745; s6 = 0.750; break;
        case 40: a1 = 0.0000; s8 = 0.2904; a2 = 7.3141; s6 = 0.820; break;
        // special HF / DFT with eBSSE correction;
        case 41: a1 = 0.5607; s8 = 3.9027; a2 = 4.5622; break;
        case 42: a1 = 0.4249; s8 = 2.1849; a2 = 4.2783; break;
        case 43: a1 = 0.1702; s8 = 0.9841; a2 = 3.8506; break;
        case 44: a1 = 0.5014; s8 = 4.0672; a2 = 4.8409; break;
        case 45: a1 = 0.3563; s8 = 1.0821; a2 = 4.3359; break;
        ...
        */
        case 46: a1 = 0.3807; s8 = 2.3363; a2 = 5.8844; break;
        case 47: a1 = 0.2211; s8 = 2.6910; a2 = 6.7278; break;
        case 48: a1 = 0.4650; s8 = 2.9215; a2 = 6.2003; break;
        // special HF - D3 - gCP - SRB / MINIX parametrization;
        case 49: a1 = 0.4171; s8 = 0.8777; a2 = 2.9149; break;
        // special HF - D3 - gCP - SRB2 / ECP - 2G parametrization;
        case 50: a1 = 0.3063; s8 = 0.5022; a2 = 3.9856; break;
        // special PBEh - D3 - gCP / def2 - mSVP parametrization;
        case 51: a1 = 0.4860; s8 = 0.0000; a2 = 4.5000; break;
        case 52: a1 = 0.4860; s8 = 0.0000; a2 = 4.5000; break;
        default:
            error->all(FLERR, "Functional name unknown");
            break;
      }
    ...
    case 4:{ // bjm
      ...
      int functionalCode = functionalMap[functional_name];
      switch (functionalCode) {
          case 1: a1 = 0.486434; s8 = 0.672820; a2 = 3.656466; s6 = 0.640000; break;
          case 2: a1 = 0.278672; s8 = 1.466677; a2 = 4.606311; break;
          case 3: a1 = 0.240184; s8 = 1.206988; a2 = 3.864426; break;
          case 4: a1 = 0.448486; s8 = 1.875007; a2 = 3.610679; break;
          case 5: a1 = 0.821850; s8 = 3.140281; a2 = 2.728151; break;
          case 6: a1 = 0.012092; s8 = 0.358940; a2 = 5.938951; break;
          case 7: a1 = 0.007912; s8 = 0.528823; a2 = 6.162326; break;
          case 8: a1 = 0.563761; s8 = 0.906564; a2 = 3.593680; break;
          default:
              error->all(FLERR, "Functional name unknown");
              break;
      }
